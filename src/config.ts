...
const mainnet = // { ...mainnetOriginal }; // use the following code for local fork testing:
{ ...mainnetOriginal, id: 31337, rpcUrls: { default: { http: [`http://127.0.0.1:8545` ] } } } satisfies Chain;
